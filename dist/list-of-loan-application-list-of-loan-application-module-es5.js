...
var ApplicationDetailsComponent = /** @class */ (function () {
    function ApplicationDetailsComponent(modalService, newLoanObj, httpService, router) {
    ...
    ApplicationDetailsComponent.prototype.openModal = function (content) {
        this.modalService.open(content);
    };
    ApplicationDetailsComponent.prototype.closeModal = function () {
        this.modalService.dismissAll();
        this.passEntry.emit(this.loanDetail);
    };
    ApplicationDetailsComponent.prototype.onSubmit = function (form) {
        var _this = this;
        if (form.valid) {
            this.httpService.getDecision(this.newLoanObj).subscribe(function (data) {
                console.log('Loan Approval Response', data);
                _this.decisonResponse = data;
                _this.router.navigate(['loanstatus'], { queryParams: { data: _this.decisonResponse } });
            }, function (error) { return console.log('Error:', error); });
        }
    };
    ApplicationDetailsComponent.ctorParameters = function () { return [
...
/* harmony import */ var ngx_bootstrap_modal___WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-bootstrap/modal/ */ "./node_modules/ngx-bootstrap/modal/fesm5/ngx-bootstrap-modal.js");
...
var ApplicationDetailsModule = /** @class */ (function () {
    function ApplicationDetailsModule() {
    }
    ...
    return ApplicationDetailsModule;
}());
...
var ListOfLoanApplicationRoutingModule = /** @class */ (function () {
    function ListOfLoanApplicationRoutingModule() {
    }
    ...
    return ListOfLoanApplicationRoutingModule;
}());
...
var ListOfLoanApplicationComponent = /** @class */ (function () {
    function ListOfLoanApplicationComponent(config, modalService, httpService) {
        this.modalService = modalService;
        this.httpService = httpService;
        this.page = 1;
        this.pageSize = 4;
    ...
    ListOfLoanApplicationComponent.prototype.ngOnInit = function () { };
    Object.defineProperty(ListOfLoanApplicationComponent.prototype, "getLoanApp", {
        get: function () {
            return this.loanApplications.map(function (loanapp, i) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: '' + i + 1 }, loanapp)); }).slice((this.page - 1) * this.pageSize, (this.page - 1) * this.pageSize + this.pageSize);
        },
        enumerable: true,
        configurable: true
    });
    ListOfLoanApplicationComponent.prototype.getAllLoanApplication = function (inputParam) {
        var _this = this;
        this.httpService.getAllLoanApplicationsForUser(inputParam).subscribe(function (data) {
            console.log('Loan Application Response', data);
            _this.loanApplications = data;
        }, function (error) { return console.log('Error:', error); });
    };
    ListOfLoanApplicationComponent.prototype.rowClicked = function (rowData) {
        var modalRef = this.modalService.open(_application_details_application_details_component__WEBPACK_IMPORTED_MODULE_2__["ApplicationDetailsComponent"], { size: 'lg' });
        modalRef.componentInstance.loanDetail = rowData;
        modalRef.result.then(function (data) { }, function (reason) { });
        modalRef.componentInstance.passEntry.subscribe(function (receivedEntry) {
            console.log(receivedEntry);
        });
    };
    ListOfLoanApplicationComponent.ctorParameters = function () { return [
    ...
    return ListOfLoanApplicationComponent;
}());
...
var ListOfLoanApplicationModule = /** @class */ (function () {
    function ListOfLoanApplicationModule() {
    }
    ...
    return ListOfLoanApplicationModule;
}());
...
//# sourceMappingURL=list-of-loan-application-list-of-loan-application-module-es5.js.map