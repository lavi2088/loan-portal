...
var NewLoanApplicationRoutingModule = /** @class */ (function () {
    function NewLoanApplicationRoutingModule() {
    }
    ...
    return NewLoanApplicationRoutingModule;
}());
...
var NewLoanApplicationComponent = /** @class */ (function () {
    function NewLoanApplicationComponent(newLoanObj, httpService, router) {
    ...
    NewLoanApplicationComponent.prototype.ngOnInit = function () {
    };
    NewLoanApplicationComponent.prototype.onSubmit = function (form) {
        var _this = this;
        if (form.valid) {
    ...
    NewLoanApplicationComponent.ctorParameters = function () { return [
    ...
    return NewLoanApplicationComponent;
}());
...
var NewLoanApplicationModule = /** @class */ (function () {
    function NewLoanApplicationModule() {
    }
    ...
    return NewLoanApplicationModule;
}());
...
//# sourceMappingURL=new-loan-application-new-loan-application-module-es5.js.map