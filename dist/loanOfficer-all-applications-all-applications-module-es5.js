...
var AllApplicationsRoutingModule = /** @class */ (function () {
    function AllApplicationsRoutingModule() {
    }
    ...
    return AllApplicationsRoutingModule;
}());
...
var AllApplicationsComponent = /** @class */ (function () {
    function AllApplicationsComponent(httpService, config, modalService) {
    ...
    AllApplicationsComponent.prototype.getAllLoanApplication = function (inputParam) {
        var _this = this;
        this.httpService.getAllLoanApplications(inputParam).subscribe(function (data) {
            console.log("Loan Application Response", data);
            _this.loanApplications = data;
        }, function (error) { return console.log('Error:', error); });
    };
    AllApplicationsComponent.prototype.rowClicked = function (rowData) {
        var _this = this;
        var modalRef = this.modalService.open(_loan_application_detail_loan_application_detail_component__WEBPACK_IMPORTED_MODULE_4__["LoanApplicationDetailComponent"], { size: 'lg' });
        ...
        modalRef.componentInstance.passEntry.subscribe(function (receivedEntry) {
            ...
            if (receivedEntry === "REFRESH") {
                _this.getAllLoanApplication({ "processDefinition": "loanApproval" });
            }
        });
    };
...
var AllApplicationsModule = /** @class */ (function () {
    function AllApplicationsModule() {
    }
...
var LoanApplicationDetailRoutingModule = /** @class */ (function () {
    function LoanApplicationDetailRoutingModule() {
    }
    ...
    return LoanApplicationDetailRoutingModule;
}());
...
var CompleteTask = /** @class */ (function () {
    function CompleteTask() {
    }
    return CompleteTask;
}());
var LoanApplicationDetailComponent = /** @class */ (function () {
    function LoanApplicationDetailComponent(modalService, newLoanObj, httpService, router) {
        this.modalService = modalService;
    ...
    LoanApplicationDetailComponent.prototype.ngOnInit = function () {
    ...
    LoanApplicationDetailComponent.prototype.openModal = function (content) {
        this.modalService.open(content);
    };
    LoanApplicationDetailComponent.prototype.closeModal = function () {
        this.modalService.dismissAll();
    };
    LoanApplicationDetailComponent.prototype.onSubmit = function (form, event) {
    ...
    LoanApplicationDetailComponent.prototype.rejectApplication = function () {
        this.completeTask = new CompleteTask();
        this.completeTask.taskId = this.loanDetail.processInstanceId;
    ...
    LoanApplicationDetailComponent.prototype.completeApplication = function (input) {
        var _this = this;
        this.httpService.completeLoanApplications(input).subscribe(function (data) {
            console.log('Data', data);
            _this.passEntry.emit('REFRESH');
            _this.closeModal();
        }, function (error) { return console.log(error); });
    };
    LoanApplicationDetailComponent.ctorParameters = function () { return [
...
var LoanApplicationDetailModule = /** @class */ (function () {
    function LoanApplicationDetailModule() {
    }
    ...
    return LoanApplicationDetailModule;
}());
...
//# sourceMappingURL=loanOfficer-all-applications-all-applications-module-es5.js.map