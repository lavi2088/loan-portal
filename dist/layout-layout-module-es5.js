...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'dashboard', loadChildren: function () { return Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("common"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/layout/dashboard/dashboard.module.ts")).then(function (m) { return m.DashboardModule; }); } },
            { path: 'charts', loadChildren: function () { return Promise.all(/*! import() | charts-charts-module */[__webpack_require__.e("common"), __webpack_require__.e("charts-charts-module")]).then(__webpack_require__.bind(null, /*! ./charts/charts.module */ "./src/app/layout/charts/charts.module.ts")).then(function (m) { return m.ChartsModule; }); } },
            { path: 'tables', loadChildren: function () { return Promise.all(/*! import() | tables-tables-module */[__webpack_require__.e("common"), __webpack_require__.e("tables-tables-module")]).then(__webpack_require__.bind(null, /*! ./tables/tables.module */ "./src/app/layout/tables/tables.module.ts")).then(function (m) { return m.TablesModule; }); } },
            { path: 'bs-element', loadChildren: function () { return Promise.all(/*! import() | bs-element-bs-element-module */[__webpack_require__.e("common"), __webpack_require__.e("bs-element-bs-element-module")]).then(__webpack_require__.bind(null, /*! ./bs-element/bs-element.module */ "./src/app/layout/bs-element/bs-element.module.ts")).then(function (m) { return m.BsElementModule; }); } },
            { path: 'grid', loadChildren: function () { return Promise.all(/*! import() | grid-grid-module */[__webpack_require__.e("common"), __webpack_require__.e("grid-grid-module")]).then(__webpack_require__.bind(null, /*! ./grid/grid.module */ "./src/app/layout/grid/grid.module.ts")).then(function (m) { return m.GridModule; }); } },
            { path: 'components', loadChildren: function () { return __webpack_require__.e(/*! import() | bs-component-bs-component-module */ "bs-component-bs-component-module").then(__webpack_require__.bind(null, /*! ./bs-component/bs-component.module */ "./src/app/layout/bs-component/bs-component.module.ts")).then(function (m) { return m.BsComponentModule; }); } },
            { path: 'blank-page', loadChildren: function () { return __webpack_require__.e(/*! import() | blank-page-blank-page-module */ "blank-page-blank-page-module").then(__webpack_require__.bind(null, /*! ./blank-page/blank-page.module */ "./src/app/layout/blank-page/blank-page.module.ts")).then(function (m) { return m.BlankPageModule; }); } },
            // tslint:disable-next-line: max-line-length
            { path: 'newloan', loadChildren: function () { return __webpack_require__.e(/*! import() | new-loan-application-new-loan-application-module */ "new-loan-application-new-loan-application-module").then(__webpack_require__.bind(null, /*! ./new-loan-application/new-loan-application.module */ "./src/app/layout/new-loan-application/new-loan-application.module.ts")).then(function (m) { return m.NewLoanApplicationModule; }); } },
            // tslint:disable-next-line: max-line-length
            { path: 'loanlist', loadChildren: function () { return Promise.all(/*! import() | list-of-loan-application-list-of-loan-application-module */[__webpack_require__.e("default~list-of-loan-application-list-of-loan-application-module~loanOfficer-all-applications-all-ap~e6de4687"), __webpack_require__.e("list-of-loan-application-list-of-loan-application-module")]).then(__webpack_require__.bind(null, /*! ./list-of-loan-application/list-of-loan-application.module */ "./src/app/layout/list-of-loan-application/list-of-loan-application.module.ts")).then(function (m) { return m.ListOfLoanApplicationModule; }); } },
            { path: 'loanstatus', loadChildren: function () { return __webpack_require__.e(/*! import() | loan-status-loan-status-module */ "loan-status-loan-status-module").then(__webpack_require__.bind(null, /*! ./loan-status/loan-status.module */ "./src/app/layout/loan-status/loan-status.module.ts")).then(function (m) { return m.LoanStatusModule; }); } },
            // tslint:disable-next-line: max-line-length
            ...
            // tslint:disable-next-line: max-line-length
            { path: 'allapplications', loadChildren: function () { return Promise.all(/*! import() | loanOfficer-all-applications-all-applications-module */[__webpack_require__.e("default~list-of-loan-application-list-of-loan-application-module~loanOfficer-all-applications-all-ap~e6de4687"), __webpack_require__.e("loanOfficer-all-applications-all-applications-module")]).then(__webpack_require__.bind(null, /*! ./loanOfficer/all-applications/all-applications.module */ "./src/app/layout/loanOfficer/all-applications/all-applications.module.ts")).then(function (m) { return m.AllApplicationsModule; }); } },
        ]
    }
];
